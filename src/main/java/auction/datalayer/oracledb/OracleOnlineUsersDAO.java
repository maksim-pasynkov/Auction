...
public class OracleOnlineUsersDAO implements OnlineUsersDAO {
	...
	public OracleOnlineUsersDAO(Connection connection) {
	...
	public List<User> getOnlineUsers(int userId) {
		...
		try {
			statement = this.connection.prepareStatement(
					QueryManager.getProperty("sql.select.online.users"));
